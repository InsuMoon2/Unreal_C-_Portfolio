#include "Character/Enemies/CEnemy_AI_Melee.h"
#include "Global.h"
...
ACEnemy_AI_Melee::ACEnemy_AI_Melee()
{
	...
	LabelWidget->SetRelativeLocation(FVector(0, 0, 250.0f));
	LabelWidget->SetDrawSize(FVector2D(200.0f, 0));
...
void ACEnemy_AI_Melee::Tick(float DeltaTime)
{
